        ...
        <section className="bg-transparent">
          <div className=" max-w-6xl mx-auto mt-2 md:mt-10 p-5 md:p-10">
            ...
            <p className="text-white text-xl text-center">
              ...
              Corporis, voluptate, recusandae ab nulla fugiat voluptatibus
              autem. Lorem ipsum dolor sit, amet consectetur adipisicing elit.
              Eum non inventore incidunt aliquid, nesciunt, excepturi totam, ab
              adipisci eligendi perferendis et.
            </p>
          </div>
        </section>
      </main>
